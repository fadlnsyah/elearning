    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm h-fit sticky top-24">
            ...
            <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-4">
                ...
                <button class="w-full py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold shadow-lg shadow-indigo-200 transition-all mt-2">Create User</button>
            </form>
        </div>
    </div>
</x-app-layout>